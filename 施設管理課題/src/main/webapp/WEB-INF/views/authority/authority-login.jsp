...
<body>
	<div id="base">
		...
		<div id="contents">
			...
			<form:form modelAttribute="authorityLoginForm" action="/login"
				method="post">
				...
				<table id="login">
					<tbody>
						<tr>
							<th>ユーザ名</th>
							<td><a style="color: red"><form:errors path="loginId" /></a>
								<form:input path="loginId" /></td>
						</tr>
						<tr>
							<th>パスワード</th>
							<td><a style="color: red"><form:errors path="password" /></a>
								<form:input path="password" /></td>
						</tr>
					</tbody>
				</table>
				<p id="login-button">
					<input type="submit" value="ログイン" /> <input type="reset"
						value="クリア" />
				</p>
			</form:form>
		</div>
