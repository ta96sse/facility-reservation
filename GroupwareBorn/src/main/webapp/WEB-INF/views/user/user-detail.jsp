		...
		<div id="contents">
			...
			<form:form modelAttribute="userFormSession" action="/user/confirm"
				...
				<table id="facility-info">
					<tr>
						<th class="facility-info-th">ユーザー名<br>
						<font size="1px" style="color: red;">※ユーザー名は変更できません</font></th>
						<td><a class="userCheck" style="color: red"></a> <form:input
								class="userId" path="loginName" readonly="true" /></td>
					</tr>
					<tr>
						<th class="facility-info-th">Password</th>
						<td><a class="passCheck" style="color: red"></a> <a
							style="color: red"><form:errors path="password1" /></a> <form:input
								class="password1" path="password1" /></td>
					</tr>
					<tr>
						<th class="facility-info-th">Password<br>
						<font size="1px">※もう一度入力してください。</font></th>
						<td><a style="color: red"><form:errors path="password2" /></a>
							<form:input class="password2" path="password2" /></td>
					</tr>
					<tr>
						<th class="facility-info-th">権限</th>
						<td><form:radiobutton path="parmissionLevel" value="1"
								label="管理者" checked="checked" /> <form:radiobutton
								path="parmissionLevel" value="2" label="ユーザー" /></td>
					<tr>
